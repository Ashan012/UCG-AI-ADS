...
function Genrator() {
  ...
  const handleGenrate = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
  };
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenrate} className="max-w-4xl mx-auto mb-40">
        <Title
          ...
          <div className="w-full">
            <div className="mb-4">
              ...
              <input
                ...
                required
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/5 outline-none transition-all"
              />
            </div>
            <div className="mb-4">
        ...
        <div className="flex justify-center mt-10">
          ...
          >
            {isGenrating ? (
              <>
                <Loader2Icon className="size-5 animate-spin" /> Genrating...
              </>
            ) : (
              <>
                <Wand2Icon className="size-5" /> Genrate Image
              </>
            )}
          </PrimaryButton>
        </div>
