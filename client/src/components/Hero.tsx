...
export default function Hero() {
  ...
  const trustedLogosText = ["Abode", "Figma", "Webflows", "Spotify", "Amazon"];
        ...
        <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="text-left">
              ...
              >
                upload model images and a model photo - Our AI instantly
                produces proffesional lifestyle imageinary and short- from video
                optimize for communication and Reels
              </motion.p>
